...
TGraphAsymmErrors *plotPDFDoubleRatio(int ptMin=25,int ptMax=55, bool isPPb=1, int pdfSet=2, int isCT=0, bool isEmbed = 0)
{
...
void plot6PanelDR(bool isPPb, int pdfSet, int isCT)
{
